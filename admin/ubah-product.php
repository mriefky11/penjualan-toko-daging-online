  ...
  if (isset($_POST["submit"])){
    ...
    echo"
        <script>
          ...
          document.location.href = 'ubah-product.php';
        </script>
      ";
  }
}
  ...
  <body>
    <div class="wrapper">
      ...
      <div class="main-pages ">
        <div class="container">
          <h2 class="text-center fw-bold">Ubah Product</h2>
          <div class="mt-4 px-5">
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-3">
                ...
                <br>
                <img src="img/<?= $data["img"]?>"a width="100" height="100" class="my-2">
